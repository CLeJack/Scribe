...
#endif
{
    addParameter (loNoteP = new juce:: AudioParameterInt ("loNote", "Lowest Note", 12, 84, 24));
    addParameter (hiNoteP = new juce:: AudioParameterInt ("hiNote", "Highest Note", 12, 84, 84));
    ...
    addParameter (channelInP  = new juce::AudioParameterInt ("channelIn", "Input Channel", 1,  getTotalNumInputChannels(), 2) );
}
